import java.util.*;
public class Assignment5Part2MultiplicationOfMatrices {
	...
	public static void main(String[] args) {
		...
		for(int row = 0 ;row < rows1 ; row ++)
			for(int col = 0 ; col < cols1 ; col++) mat1[row][col] = sc.nextInt();
		...
		for(int row = 0 ;row < rows2 ; row ++)
			for(int col = 0 ; col < cols2 ; col++) mat2[row][col] = sc.nextInt();
		if(cols1 != rows2) {
